...
<div class="inf">
        ...
        <h2> User Information </h2>
         <img class="profileimg" style="width: 100px;" src="https://www.gravatar.com/avatar/0c4cfef9aae14fe22e081aa62234df88?s=100&d=identicon&r=PG<?=md5(strtolower(trim($di->session->get("user"))));?>"/></br></br>
